...
(define-key semi-colon-map (kbd "y")   'x-clipboard-yank)
(define-key semi-colon-map (kbd "C-y") 'x-clipboard-yank)
(define-key semi-colon-map (kbd "w")   'clipboard-kill-region)
(define-key semi-colon-map (kbd "C-w") 'clipboard-kill-region)
