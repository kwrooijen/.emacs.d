...
(custom-set-faces
 ...
 '(ac-candidate-face ((t (:inherit popup-face :background "#2B2B2B" :foreground "#8FB28F"))))
 '(ac-selection-face ((t (:inherit popup-menu-selection-face :background "#6F6F6F" :foreground "#8FB28F"))))
 '(ac-yasnippet-candidate-face ((t (:inherit ac-candidate-face :background "#2B2B2B" :foreground "#F0DFAF"))))
 '(ac-yasnippet-selection-face ((t (:background "#6F6F6F" :foreground "#F0DFAF"))))
 ...
 '(flymake-errline ((t (:foreground "#ff0000" :underline "#ff0000"))))
 '(flymake-warnline ((((class color)) (:foreground "#ffeb08" :underline "#ffeb08"))))
